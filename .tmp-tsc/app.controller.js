...
let AppController = (() => {
    ...
    (() => {
        ...
        _testOracle_decorators = [(0, common_1.Get)('test-oracle')];
        ...
        __esDecorate(_classThis, null, _testOracle_decorators, { kind: "method", name: "testOracle", static: false, private: false, access: { has: obj => "testOracle" in obj, get: obj => obj.testOracle }, metadata: _metadata }, null, _instanceExtraInitializers);
